...
# ---------------------------------------------------------------------
# Define a function to scrape all the match data given the match id and export as csv files
...
# Define a function to plot the average positions and attacking third zones
def plot_average_positions(team, team_colour, home_team):
    ...
    player_stats = player_stats[["id","substitute"]]
    ...
    for _, player in team_xi.iterrows():
        ...
        pitch.annotate(
            player["shortName"],
            xy = (player["plot_x"], player["plot_y"]),
            xytext = (0,-20),
    ...
    left_y_min = 68 * 0.6667
    left_y_max = 68
    
    central_y_min = 68 * 0.3333
    central_y_max = 68 * 0.6667
    
    right_y_min = 0
    right_y_max = 68 * 0.3333
...
# Define a function that creates a momentum graph
...
# Define a function to create a cumalative xG plot
...
# Define a new function to plot a shot map
